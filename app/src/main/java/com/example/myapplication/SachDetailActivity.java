...
public class SachDetailActivity extends AppCompatActivity {
    ...
    public void capsua(View view) {
        try {
            if (sachDAO.updateSach(maSachk, maSach.getText().toString(), tenSach.getText().toString(), tacgia.getText().toString(),
                    nxb.getText().toString(), Double.parseDouble(giaban.getText().toString()), Integer.parseInt(soluong.getText().toString())) > 0) {
